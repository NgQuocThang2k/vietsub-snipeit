...
return [
    ...
    'admin_tooltip'			=> 'Người dùng này có quyền quản trị viên',
    'superuser'				=> 'Người dùng cao cấp',
    'superuser_tooltip'		=> 'Người dùng này có quyền cao',
    ...
    'checkout'  			=> 'Cấp phát',
    'checkouts_count'       => 'Cấp phát tài sản',
    'checkins_count'        => 'Đăng ký tài sản',
    'checkin_and_delete'  	=> 'Nhập  & Xóa',
    ...
    'not_deleted'           => 'Mục :item_type chưa được xóa và do đó không thể khôi phục',
    'create'				=> 'Tạo mới',
    'created'               => 'Mục đã tạo',
    ...
    'qty'		            => 'Số lượng',
    'quantity'		        => 'Số lượng',
    'quantity_minimum'      => 'Bạn có một mục dưới hoặc ít hơn số lượng tối thiểu|Bạn có :count mục dưới hoặc ít hơn số lượng tối thiểu',
    ...
    'select_location'		=> 'Lựa chọn một Địa diểm',
    ...
    'webhook_test_msg'        => 'Xin chào! Có vẻ như tích hợp :app của bạn với Snipe-IT đang hoạt động!',
    ...
    'status_label'			=> 'Tình trạng nhãn',
    'status'    			=> 'Tình trạng',
    'accept_eula'           => 'Chấp nhận quy định',
    'show_or_hide_eulas' => 'Hiển thị/Ẩn EULA',
    ...
    'viewassetsfor'         => 'Xem tài sản :name',
    'website'               => 'Website',
    ...
    'token_expired'         => 'Token của bạn đã hết hạn. Vui lòng thử lại.',
    'login_enabled'         => 'Cho phép đăng nhập',
    'audit_due'             => 'Hết hạn kiểm toán',
    'audit_due_days'        => '{}Tài sản đến hạn hoặc quá hạn kiểm kê|[1]Tài sản đến hạn hoặc quá hạn kiểm kê trong vòng một ngày|[2,*]Tài sản đến hạn hoặc quá hạn kiểm kê trong vòng :days ngày',
    'checkin_due'           => 'Đến hạn nhập kho',
    'checkin_overdue'       => 'Quá hạn nhập kho',
    'checkin_due_days'      => '{}Đến hạn nhập kho|[1]Tài sản đến hạn nhập kho trong vòng :days ngày|[2,*]Tài sản đến hạn nhập kho trong vòng :days ngày',
    ...
    'fields'                => 'Các trường',
    'last_checkout'         => 'Lần cuối cấp phát',
    ...
    'new_license'           => 'Bảng quyền mới',
    'new_accessory'         => 'Thêm phụ kiện',
    'new_consumable'        => 'Tạo vật phẩm tiêu hao',
    'collapse'              => 'Thu gọn',
    'assigned'              => 'Đã giao',
    'asset_count'           => 'Tổng tài sản',
    'accessories_count'     => 'Tổng phụ kiện',
    'consumables_count'     => 'Tổng vật phẩm tiêu hao',,
    'components_count'      => 'Tổng vật phẩm thành phần',
    'licenses_count'        => 'Tổng Ban quyền',
    'notification_error'    => 'Lỗi',
    'notification_error_hint' => 'Vui lòng kiểm tra biểu mẫu dưới đây để tìm lỗi',
    'notification_bulk_error_hint' => 'Các trường sau có lỗi xác thực và không được chỉnh sửa:',
    'notification_success'  => 'Thành công',
    'notification_warning'   => 'Cảnh báo',
    'notification_info'      => 'Thông tin',
    'asset_information'     => 'Thông tin về tai sản',
    'model_name'            => 'Model Name',
    'asset_name'            => 'Tên tài sản',
    'consumable_information' => 'Thông tin về vật phẩm tiêu hao:',
    'consumable_name'       => 'Tên vật tư phụ:',
    'accessory_information' => 'Thông tin về phụ kiện:',
    ...
    'checkin_to_diff_location' => 'Bạn có thể chọn thu hồi tài sản này vào một vị trí khác với vị trí mặc định của tài sản là :default_location nếu đã được thiết lập',
    'maintenance_mode'      => 'Dịch vụ tạm thời không khả dụng do cập nhật hệ thống. Vui lòng quay lại sau.',
    'maintenance_mode_title' => 'Hệ thống tạm thời không khả dụng',
    'ldap_import'           => 'Mật khẩu người dùng không nên được quản lý bởi LDAP. (Điều này cho phép bạn gửi yêu cầu quên mật khẩu.)',
    'purge_not_allowed'     => 'Xóa dữ liệu đã xóa đã bị vô hiệu hóa trong tệp .env. Liên hệ với bộ phận hỗ trợ hoặc quản trị viên hệ thống của bạn.',
    'backup_delete_not_allowed'     => 'Xóa bản sao lưu đã bị vô hiệu hóa trong tệp .env. Liên hệ với bộ phận hỗ trợ hoặc quản trị viên hệ thống của bạn.',
    'additional_files'           => 'Các tệp bổ sung',
    'shitty_browser'        => 'Không phát hiện chữ ký. Nếu bạn đang sử dụng trình duyệt cũ, vui lòng sử dụng trình duyệt phiên bản mới hơn để hoàn thành việc chấp nhận tài sản.',
    'bulk_soft_delete'      =>'Soft-delete những người dùng này. Lịch sử tài sản của họ sẽ được giữ nguyên trừ khi/cho đến khi bạn xóa hoàn toàn các bản ghi đã xóa trong Cài đặt quản trị.',
    ...
    'set_users_field_to_null'  => 'Xóa giá trị :field cho người dùng này|Xóa giá trị :field cho tất cả :user_count người dùng',
    ...
    'errors_importing'          => 'Đã xảy ra một số lỗi khi nhập: ',
    'warning'                   => 'CẢNH BÁO: :warning',
    'success_redirecting'       => 'Thành công... Đang chuyển hướng.',
    'cancel_request'            => 'Hủy yêu cầu mục này',
    'setup_successful_migrations' => 'Bảng cơ sở dữ liệu của bạn đã được tạo',
    'setup_migration_output' => 'Kết quả di chuyển:',
    'setup_migration_create_user' => 'Tiếp theo: Tạo người dùng',
    'importer_generic_error'    => 'Quá trình nhập tệp của bạn đã hoàn tất, nhưng chúng tôi đã nhận được lỗi. Điều này thường do giới hạn API từ webhook thông báo (như Slack) và không ảnh hưởng đến quá trình nhập, nhưng bạn nên xác nhận điều này.',
    'confirm' => 'Xác nhận',
    'autoassign_licenses' => 'Tự động gán giấy phép',
    'autoassign_licenses_help' => 'Cho phép người dùng này được gán giấy phép thông qua giao diện gán giấy phép hàng loạt hoặc công cụ CLI.',
    'autoassign_licenses_help_long' => 'Điều này cho phép người dùng được gán giấy phép thông qua giao diện gán giấy phép hàng loạt hoặc công cụ CLI. (Ví dụ, bạn có thể không muốn nhà thầu được tự động gán giấy phép mà bạn chỉ cung cấp cho nhân viên. Bạn vẫn có thể gán riêng giấy phép cho những người dùng đó, nhưng họ sẽ không được bao gồm trong chức năng Cấp giấy phép cho tất cả người dùng.)',
    'no_autoassign_licenses_help' => 'Không bao gồm người dùng để gán hàng loạt thông qua giao diện giấy phép hoặc công cụ CLI.',
    'modal_confirm_generic'      => 'Bạn có chắc không?',
    'cannot_be_deleted'      => 'Mục này không thể bị xóa',
    'cannot_be_edited'      => 'Mục này không thể được chỉnh sửa.',
    'undeployable_tooltip'      => 'Mục này không thể cấp phát. Kiểm tra lại số lượng tồn.',
    'serial_number'        => 'Serial Number',
    'item_notes' => ':item Notes',
    'item_name_var' => ':tên thiết bị',
    'error_user_company' => 'Cấp phát tài sản và công ty tài sản không khớp',
    'error_user_company_accept_view' => 'Một tài sản được gán cho bạn thuộc về một công ty khác nên bạn không thể chấp nhận hoặc từ chối nó, vui lòng kiểm tra với quản lý của bạn',
    'importer' => [
    ...
    'action_permission_denied' => 'Bạn không có quyền để :action :item_type ID :id',
    'action_permission_generic' => 'Bạn không có quyền để :action mục :item_type này',
    'edit' => 'sửa',
    'action_source' => 'Action Source',
    'or' => 'or',
    'url'                   => 'URL',
    'edit_fieldset' => 'Edit fieldset fields and options',
    'permission_denied_superuser_demo' => 'Quyền truy cập bị từ chối. Bạn không thể cập nhật thông tin người dùng cho quản trị viên cấp cao trong bản demo.',
    'pwd_reset_not_sent' => 'Người dùng chưa được kích hoạt, được đồng bộ hóa LDAP hoặc không có địa chỉ email',
    'error_sending_email' => 'Lỗi khi gửi email',
    'sad_panda' => 'Rất tiếc. Bạn không được phép thực hiện hành động này. Có thể <a href=":link">quay lại bảng điều khiển</a>, hoặc liên hệ với quản trị viên của bạn.',
    'bulk' => [
            'delete' =>
                [
                'header' => 'Xóa hàng loạt :object_type',
                'warn'   =>  'Bạn sắp xóa một :object_type|Bạn sắp xóa :count :object_type',
                'success'   =>  ':object_type đã xóa thành công|Đã xóa thành công :count :object_type',
                'error'   =>  'Không thể xóa :object_type',
                'nothing_selected'   =>  'Không có :object_type nào được chọn - không có gì để làm',
                'partial'   =>  'Đã xóa :success_count :object_type, nhưng :error_count :object_type không thể được xóa',
             ],
    ],
    'no_requestable' => 'Không có tài sản hoặc model nào có thể yêu cầu.',

    'countable' => [
        'accessories'  => ':count Phụ kiện|:count Phụ kiện',
        'assets'  => ':count Tài sản|:count Tài sản',
        'licenses'  => ':count Bản quyền|:count Bản quyền',
        'license_seats'  => ':count Số lượng Bản quyền|:count Số lượng Chỗ Bản quyền',
        'consumables'  => ':count Vật phẩm tiêu hao|:count Vật phẩm tiêu hao',
        'components'  => ':count Linh kiện|:count Linh kiện',
    ],

    'more_info' => 'Xem thêm thông tin',
    'quickscan_bulk_help' => 'Đánh dấu ô này sẽ chỉnh sửa bản ghi tài sản để phản ánh vị trí mới này. Để trống sẽ chỉ ghi lại vị trí trong nhật ký kiểm kê. Lưu ý rằng nếu tài sản này đang được cấp phát, nó sẽ không thay đổi vị trí của người, tài sản hoặc vị trí mà nó được cấp phát cho.',
    'whoops' => 'Rất tiếc!',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'Tài sản với thẻ tài sản :asset_tag đã tồn tại và không có yêu cầu cập nhật. Không có thay đổi nào được thực hiện.',
    'countries_manually_entered_help' => 'Giá trị có dấu sao (*) được nhập thủ công và không khớp với giá trị dropdown ISO 3166 hiện có',
    'accessories_assigned' => 'Phụ kiện đã gán',
    'user_managed_passwords' => 'Quản lý mật khẩu',
    'user_managed_passwords_disallow' => 'Không cho phép người dùng quản lý mật khẩu của họ',
    'user_managed_passwords_allow' => 'Cho phép người dùng quản lý mật khẩu của họ',
    ...
    'generic_model_not_found' => ':model không tìm thấy hoặc bạn không có quyền ',
    'deleted_models' => 'Kiểu mẫu đã xóa',
