...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'no_scopes' => 'No scopes',
    'asset_tag_title' => 'Cập nhật cài đặt tag tài sản',
    'barcode_title' => 'Cập nhật cài đặt mã vạch',
    'barcodes' => 'Mã vạch',
    'barcodes_help_overview' => 'Cài đặt mã vạch & QR',
    'barcodes_help' => 'Thao tác này sẽ xóa các mã vạch đã lưu trong bộ nhớ đệm. Thường chỉ sử dụng khi cài đặt mã vạch của bạn thay đổi, hoặc URL của Snipe-IT đã thay đổi. Mã vạch sẽ được tạo lại khi truy cập lần sau.',
    'barcodes_spinner' => 'Đang xóa tệp...',
    'barcode_delete_cache' => 'Xóa bộ nhớ đệm mã vạch',
    'branding_title' => 'Cập nhật cài đặt thương hiệu',
    'general_title' => 'Cập nhật cài đặt chung',
    'mail_test' => 'Gửi thử',
    'mail_test_help' => 'Thao tác này sẽ gửi một email thử đến :replyto.',
    'filter_by_keyword' => 'Lọc theo từ khóa cài đặt',
    'security' => 'Bảo mật',
    'security_title' => 'Cập nhật cài đặt bảo mật',
    'security_help' => 'Xác thực hai yếu tố, hạn chế mật khẩu',
    'groups_help' => 'Nhóm quyền tài khoản',
    'localization' => 'Quốc gia',
    'localization_title' => 'Cập nhật cài đặt bản địa hóa',
    'localization_help' => 'Ngôn ngữ, hiển thị ngày tháng',
    'notifications' => 'Thông báo',
    'notifications_help' => 'Cảnh báo qua email & cài đặt kiểm tra',
    'asset_tags_help' => 'Tự động tăng và tiền tố',
    'labels' => 'Nhãn',
    'labels_title' => 'Cập nhật cài đặt nhãn',
    'labels_help' => 'Cài đặt mã vạch & nhãn',
    'purge_help' => 'Xóa các bản ghi đã xóa',
    'ldap_extension_warning' => 'Dường như phần mở rộng LDAP chưa được cài đặt hoặc kích hoạt trên máy chủ này. Bạn vẫn có thể lưu cài đặt, nhưng cần phải kích hoạt phần mở rộng LDAP cho PHP trước khi đồng bộ hóa LDAP hoặc đăng nhập hoạt động.',
    'ldap_ad' => 'LDAP/AD',
    'ldap_test_label' => 'Kiểm tra đồng bộ LDAP',
    'ldap_test_login' => 'Kiểm tra đăng nhập LDAP',
    ...
    'create_admin_success' => 'Thành công! Người dùng quản trị của bạn đã được thêm!',
    'create_admin_redirect' => 'Nhấn vào đây để đi đến trang đăng nhập!',
    'setup_migrations' => 'Di chuyển cơ sở dữ liệu ::',
    'setup_no_migrations' => 'Không có gì để di chuyển. Bảng cơ sở dữ liệu của bạn đã được thiết lập!',
    ...
    'slack_test' => 'Kiểm tra tích hợp <i class="fab fa-slack"></i>',
    'label2_enable'           => 'Công cụ nhãn mới',
    'label2_enable_help'      => 'Chuyển sang công cụ nhãn mới. <b>Lưu ý: Bạn cần lưu cài đặt này trước khi đặt các cài đặt khác.</b>',
    'label2_template'         => 'Mẫu',
    'label2_template_help'    => 'Chọn mẫu để sử dụng cho việc tạo nhãn',
    'label2_title'            => 'Tiêu đề',
    'label2_title_help'       => 'Tiêu đề hiển thị trên nhãn nếu được hỗ trợ',
    'label2_title_help_phold' => 'Ký tự đặc biệt <code>{COMPANY}</code> sẽ được thay thế bằng tên công ty của tài sản',
    'label2_asset_logo'       => 'Sử dụng logo tài sản',
    'label2_asset_logo_help'  => 'Sử dụng logo của công ty được gán cho tài sản, thay vì giá trị tại <code>:setting_name</code>',
    'label2_1d_type'          => 'Loại mã vạch 1D',
    'label2_1d_type_help'     => 'Định dạng cho mã vạch 1D',
    'label2_2d_type'          => 'Loại mã vạch 2D',
    'label2_2d_type_help'     => 'Định dạng cho mã vạch 2D',
    'label2_2d_target'        => 'Đích mã vạch 2D',
    'label2_2d_target_help'   => 'Dữ liệu sẽ được chứa trong mã vạch 2D',
    'label2_fields'           => 'Định nghĩa trường',
    'label2_fields_help'      => 'Các trường có thể được thêm, xóa và sắp xếp lại trong cột bên trái. Đối với mỗi trường, nhiều tùy chọn Nhãn và Nguồn dữ liệu có thể được thêm, xóa và sắp xếp lại trong cột bên phải.',
    'help_asterisk_bold'    => 'Văn bản nhập dạng <code>**văn bản**</code> sẽ hiển thị ở dạng đậm',
    'help_blank_to_use'     => 'Để trống để sử dụng giá trị từ <code>:setting_name</code>',
    'help_default_will_use' => '<code>:default</code> sẽ sử dụng giá trị từ <code>:setting_name</code>. <br>Lưu ý rằng giá trị của mã vạch phải tuân thủ thông số kỹ thuật tương ứng để được tạo thành công. Vui lòng xem <a href="https://snipe-it.readme.io/docs/barcodes">tài liệu <i class="fa fa-external-link"></i></a> để biết thêm chi tiết.',
    'asset_id'              => 'ID tài sản',
    'data'               => 'Dữ liệu',
    'default'               => 'Mặc định',
    'none'                  => 'Không có',
    'google_callback_help' => 'Điều này cần được nhập làm URL gọi lại trong cài đặt ứng dụng OAuth của Google trong <strong><a href="https://console.cloud.google.com/" target="_blank">bảng điều khiển nhà phát triển Google <i class="fa fa-external-link" aria-hidden="true"></i></a></strong> của tổ chức bạn.',
    'google_login'      => 'Cài đặt đăng nhập Google Workspace',
    'enable_google_login'  => 'Cho phép người dùng đăng nhập bằng Google Workspace',
    'enable_google_login_help'  => 'Người dùng sẽ không được tạo tự động. Họ phải có tài khoản hiện có ở đây VÀ trong Google Workspace, và tên người dùng của họ ở đây phải khớp với địa chỉ email Google Workspace của họ.',
    'mail_reply_to' => 'Địa chỉ trả lời thư',
    'mail_from' => 'Địa chỉ gửi thư',
    'database_driver' => 'Trình điều khiển cơ sở dữ liệu',
    'bs_table_storage' => 'Lưu trữ bảng',
    'timezone' => 'Múi giờ',
    'profile_edit'          => 'Chỉnh sửa hồ sơ',
    'profile_edit_help'          => 'Cho phép người dùng chỉnh sửa hồ sơ của riêng họ.',
    'default_avatar' => 'Tải lên hình đại diện mặc định tùy chỉnh',
    'default_avatar_help' => 'Hình ảnh này sẽ được hiển thị làm hồ sơ nếu người dùng không có ảnh hồ sơ.',
    'restore_default_avatar' => 'Khôi phục <a href=":default_avatar" data-toggle="lightbox" data-type="image">hình đại diện mặc định ban đầu của hệ thống</a>',
    'restore_default_avatar_help' => '',
    'due_checkin_days' => 'Cảnh báo đến hạn trả',
    'due_checkin_days_help' => 'Bao nhiêu ngày trước khi tài sản đến hạn trả thì nó sẽ được liệt kê trong trang "Đến hạn trả"?',
    'no_groups' => 'Chưa có nhóm nào được tạo. Truy cập <code>Cài đặt quản trị > Nhóm quyền</code> để thêm nhóm.',

    /* Keywords for settings overview help */
    'keywords' => [
        'brand'             => 'chân trang, logo, in, chủ đề, giao diện, header, màu sắc, màu, css',
        'general_settings'  => 'công ty hỗ trợ, chữ ký, chấp nhận, định dạng email, định dạng tên người dùng, hình ảnh, mỗi trang, hình thu nhỏ, eula, gravatar, điều khoản dịch vụ, bảng điều khiển, quyền riêng tư',
        'groups'            => 'quyền, nhóm quyền, ủy quyền',
        'labels'            => 'nhãn, mã vạch, in nhãn, trang in, in, upc, qr, 1d, 2d',
        'localization'      => 'bản địa hóa, tiền tệ, địa phương, múi giờ, quốc tế, đa ngôn ngữ, ngôn ngữ, các ngôn ngữ, dịch thuật',
        'php_overview'      => 'phpinfo, hệ thống, thông tin',
        'purge'             => 'xóa vĩnh viễn',
        'security'          => 'mật khẩu, các mật khẩu, yêu cầu, xác thực hai yếu tố, hai bước, mật khẩu phổ biến, đăng nhập từ xa, đăng xuất, xác thực',
    ],
